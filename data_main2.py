...
_data_re  = re.compile(rf'^train_data_({_var_pat})_({_station_pat})_{TI}\_autumn.npy$')
_label_re = re.compile(rf'^train_labels_({_station_pat})_{TI}\_autumn.npy$')
_time_re  = re.compile(rf'^train_time_({_station_pat})_{TI}\_autumn.npy$')
